...
var Particle = function(name, sum, category){
    ...
    switch(this.categoryName){
        case "software":
            this.color = {h:220, s:40, b:80};
            break;
            
             case "web":
            this.color = {h:240, s:40, b:90};
            break;
            
             case "biotech":
            this.color = {h:260, s:30, b:90};
            break;
             case "mobile":
            this.color = {h:290, s:30, b:90};
            break;
             case "enterprise":
            this.color = {h:320, s:25, b:95};
            break;
             case "ecommerce":
            this.color = {h:350, s:20, b:96};
            break;
        default: 
            this.color= {h:221,s:23,b:90};
    }
